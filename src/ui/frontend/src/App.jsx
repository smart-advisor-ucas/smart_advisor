    ...
    <div className={`app ${darkMode ? 'dark' : ''}`}>
      ...
      <header className="header">
        <div className="header-top">
          ...
          />
          <h1 className="header-title">المستشار الأكاديمي الذكي لتخصص علم البيانات والذكاء الاصطناعي</h1>
        </div>
        <p className="header-subtitle">Data Science and Artificial Intelligence Smart Advisor</p>
